...
const features = [
  {
    ...
    description: 'Engage in natural conversations with AI-powered historical figures. Ask questions, debate ideas, and learn through authentic dialogue.',
    visual: 'roleplay',
    color: '#7C3AED',
  },
  {
    ...
    description: 'Witness and participate in conversations between multiple historical figures. Experience the clash of ideas that shaped history.',
    visual: 'multichar',
    color: '#06B6D4',
  },
  {
    ...
    description: 'Complete learning objectives through interactive missions. Solve puzzles, make discoveries, and earn XP as you progress.',
    visual: 'missions',
    color: '#A78BFA',
  },
  {
